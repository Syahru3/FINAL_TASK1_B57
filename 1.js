...
function totalInvestasi2Tahun() {
    ...
    const totalInvestment = totalDeposit + totalObligasi + totalSahamA + totalSahamB;
...
// Tampilkan hasil
console.log(`Total uang investor setelah dua tahun adalah: Rp ${totalNilaiInvestasi.toLocaleString()}`);
